...
Set the names as `BASIC_AUTH_PASSWORD` and `BASIC_AUTH_USER` and set the user name and password as environment
variables, respectively.

<img src="./img/env.webp" alt="general" width="100%" height="auto">
